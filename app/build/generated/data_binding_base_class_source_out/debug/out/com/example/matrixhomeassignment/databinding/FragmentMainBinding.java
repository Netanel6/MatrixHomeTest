...
public final class FragmentMainBinding implements ViewBinding {
  ...
  private FragmentMainBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView dataRv,
  ...
  public static FragmentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.data_rv;
      RecyclerView dataRv = ViewBindings.findChildViewById(rootView, id);
      if (dataRv == null) {
        break missingId;
      }
      ...
      return new FragmentMainBinding((FrameLayout) rootView, dataRv, progressBar);
    }
